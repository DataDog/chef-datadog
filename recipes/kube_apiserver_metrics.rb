...
# node.datadog.kube_apiserver_metrics = {
...
datadog_monitor 'kube_apiserver_metrics' do
  init_config node['datadog']['kube_apiserver_metrics']['init_config']
  instances node['datadog']['kube_apiserver_metrics']['instances']
  logs node['datadog']['kube_apiserver_metrics']['logs']
