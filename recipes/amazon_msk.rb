...
# Monitor Amazon Kafka
#
# Here is the description of acceptable attributes:
# node.datadog.amazon_msk = {
...
#   "instances" => [
#     {
#       # cluster_arn - required: true  - string
#       "cluster_arn" => nil,
#       # region_name - required: false  - string
#       "region_name" => nil,
#       # jmx_exporter_port - required: false  - integer
#       "jmx_exporter_port" => 11001,
#       # node_exporter_port - required: false  - integer
...
datadog_monitor 'amazon_msk' do
  init_config node['datadog']['amazon_msk']['init_config']
  instances node['datadog']['amazon_msk']['instances']
  logs node['datadog']['amazon_msk']['logs']
