...
@test "tcp_check.yaml is correct" {
  ...
  expected='{"instances": [{"host": "localhost", "name": "test", "port": 1234}, {"port": 5678, "host": "localhost", "notify": ["user@example.com", "pagerduty"], "name": "test with notify"}], "init_config": null}'
